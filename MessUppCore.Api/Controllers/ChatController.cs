...
namespace MessUppCore.Api.Controllers
{
    ...
    public class ChatController : ApiController
    {
        ...
        /// <exception cref="HttpResponseException">Ошибка обработки запроса.</exception>
        [Microsoft.AspNetCore.Mvc.HttpGet("{id}/add/profile/{personId}")]
        ...
        /// <param name="personId">Идентификатор пользователя.</param>
        /// <exception cref="HttpResponseException">Ошибка обработки запроса.</exception>
        [Microsoft.AspNetCore.Mvc.HttpGet("{id}/delete/profile/{personId}")]
        ...
        /// <exception cref="HttpResponseException">Ошибка обработки запроса.</exception>
        [Microsoft.AspNetCore.Mvc.HttpGet("{id}/get/profiles")]
        ...
        /// <exception cref="HttpResponseException">Ошибка обработки запроса.</exception>
        [Microsoft.AspNetCore.Mvc.HttpGet("find/chats")]
