...
namespace MessUppCore.Api.Controllers
{
    ...
    public class MessageController : ApiController
    {
        ...
        /// <exception cref="HttpResponseException">Ошибка обработки запроса.</exception>
        [Microsoft.AspNetCore.Mvc.HttpGet("chat/{id}/profile/{profileId}")]
        ...
        /// <exception cref="HttpResponseException">Ошибка обработки запроса.</exception>
        [Microsoft.AspNetCore.Mvc.HttpGet("chat/{id}/profile/{profileId}/noread")]
        ...
        /// <exception cref="HttpResponseException">Ошибка обработки запроса.</exception>
        [Microsoft.AspNetCore.Mvc.HttpGet("chat/{chatId}/profile/{profileId}/count")]
        ...
        /// <exception cref="HttpResponseException">Ошибка обработки запроса.</exception>
        [Microsoft.AspNetCore.Mvc.HttpGet("chat/{chatId}/profile/{profileId}/read")]
        ...
        /// <exception cref="HttpResponseException">Ошибка обработки запроса.</exception>
        [Microsoft.AspNetCore.Mvc.HttpGet("find/messages")]
